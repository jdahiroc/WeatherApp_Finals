...
import com.example.test.constant.Const.Companion.LOADING
import com.example.test.constant.Const.Companion.NA
import com.example.test.model.weather.WeatherResult
import com.example.test.utils.utils.Companion.buildIcon
import com.example.test.utils.utils.Companion.timestampToHumanDate
...
fun WeatherSection(weatherResponse: WeatherResult) {
    ...
    */
    ...
    WeatherTitleSection(text = title, subText = subTitle, fontSize = 25.sp)
